                              ...
                              <i class="mdi mdi-map-marker"></i> Thông tin về điểm tập kết phế liệu
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control @error('province') is-invalid @enderror"
                                                ...
                                                <option value="TP. Hồ Chí Minh" {{ old('province', $collectionPoint->province) == 'TP. Hồ Chí Minh' ? 'selected' : '' }}>TP. Hồ Chí Minh</option>
                                                <option value="Hà Nội" {{ old('province', $collectionPoint->province) == 'Hà Nội' ? 'selected' : '' }}>Hà Nội</option>
                                                <option value="Đà Nẵng" {{ old('province', $collectionPoint->province) == 'Đà Nẵng' ? 'selected' : '' }}>Đà Nẵng</option>
                                                <option value="Cần Thơ" {{ old('province', $collectionPoint->province) == 'Cần Thơ' ? 'selected' : '' }}>Cần Thơ</option>
                                                <option value="Hải Phòng" {{ old('province', $collectionPoint->province) == 'Hải Phòng' ? 'selected' : '' }}>Hải Phòng</option>
                                                <option value="An Giang" {{ old('province', $collectionPoint->province) == 'An Giang' ? 'selected' : '' }}>An Giang</option>
                                                <option value="Bà Rịa - Vũng Tàu" {{ old('province', $collectionPoint->province) == 'Bà Rịa - Vũng Tàu' ? 'selected' : '' }}>Bà Rịa - Vũng Tàu</option>
                                                <option value="Bạc Liêu" {{ old('province', $collectionPoint->province) == 'Bạc Liêu' ? 'selected' : '' }}>Bạc Liêu</option>
                                                <option value="Bắc Giang" {{ old('province', $collectionPoint->province) == 'Bắc Giang' ? 'selected' : '' }}>Bắc Giang</option>
                                                <option value="Bắc Kạn" {{ old('province', $collectionPoint->province) == 'Bắc Kạn' ? 'selected' : '' }}>Bắc Kạn</option>
                                                <option value="Bắc Ninh" {{ old('province', $collectionPoint->province) == 'Bắc Ninh' ? 'selected' : '' }}>Bắc Ninh</option>
                                                <option value="Bến Tre" {{ old('province', $collectionPoint->province) == 'Bến Tre' ? 'selected' : '' }}>Bến Tre</option>
                                                <option value="Bình Dương" {{ old('province', $collectionPoint->province) == 'Bình Dương' ? 'selected' : '' }}>Bình Dương</option>
                                                <option value="Bình Định" {{ old('province', $collectionPoint->province) == 'Bình Định' ? 'selected' : '' }}>Bình Định</option>
                                                <option value="Bình Phước" {{ old('province', $collectionPoint->province) == 'Bình Phước' ? 'selected' : '' }}>Bình Phước</option>
                                                <option value="Bình Thuận" {{ old('province', $collectionPoint->province) == 'Bình Thuận' ? 'selected' : '' }}>Bình Thuận</option>
                                                <option value="Cà Mau" {{ old('province', $collectionPoint->province) == 'Cà Mau' ? 'selected' : '' }}>Cà Mau</option>
                                                <option value="Cao Bằng" {{ old('province', $collectionPoint->province) == 'Cao Bằng' ? 'selected' : '' }}>Cao Bằng</option>
                                                <option value="Đắk Lắk" {{ old('province', $collectionPoint->province) == 'Đắk Lắk' ? 'selected' : '' }}>Đắk Lắk</option>
                                                <option value="Đắk Nông" {{ old('province', $collectionPoint->province) == 'Đắk Nông' ? 'selected' : '' }}>Đắk Nông</option>
                                                <option value="Điện Biên" {{ old('province', $collectionPoint->province) == 'Điện Biên' ? 'selected' : '' }}>Điện Biên</option>
                                                <option value="Đồng Nai" {{ old('province', $collectionPoint->province) == 'Đồng Nai' ? 'selected' : '' }}>Đồng Nai</option>
                                                <option value="Đồng Tháp" {{ old('province', $collectionPoint->province) == 'Đồng Tháp' ? 'selected' : '' }}>Đồng Tháp</option>
                                                <option value="Gia Lai" {{ old('province', $collectionPoint->province) == 'Gia Lai' ? 'selected' : '' }}>Gia Lai</option>
                                                <option value="Hà Giang" {{ old('province', $collectionPoint->province) == 'Hà Giang' ? 'selected' : '' }}>Hà Giang</option>
                                                <option value="Hà Nam" {{ old('province', $collectionPoint->province) == 'Hà Nam' ? 'selected' : '' }}>Hà Nam</option>
                                                <option value="Hà Tĩnh" {{ old('province', $collectionPoint->province) == 'Hà Tĩnh' ? 'selected' : '' }}>Hà Tĩnh</option>
                                                <option value="Hải Dương" {{ old('province', $collectionPoint->province) == 'Hải Dương' ? 'selected' : '' }}>Hải Dương</option>
                                                <option value="Hậu Giang" {{ old('province', $collectionPoint->province) == 'Hậu Giang' ? 'selected' : '' }}>Hậu Giang</option>
                                                <option value="Hòa Bình" {{ old('province', $collectionPoint->province) == 'Hòa Bình' ? 'selected' : '' }}>Hòa Bình</option>
                                                <option value="Hưng Yên" {{ old('province', $collectionPoint->province) == 'Hưng Yên' ? 'selected' : '' }}>Hưng Yên</option>
                                                <option value="Khánh Hòa" {{ old('province', $collectionPoint->province) == 'Khánh Hòa' ? 'selected' : '' }}>Khánh Hòa</option>
                                                <option value="Kiên Giang" {{ old('province', $collectionPoint->province) == 'Kiên Giang' ? 'selected' : '' }}>Kiên Giang</option>
                                                <option value="Kon Tum" {{ old('province', $collectionPoint->province) == 'Kon Tum' ? 'selected' : '' }}>Kon Tum</option>
                                                <option value="Lai Châu" {{ old('province', $collectionPoint->province) == 'Lai Châu' ? 'selected' : '' }}>Lai Châu</option>
                                                <option value="Lâm Đồng" {{ old('province', $collectionPoint->province) == 'Lâm Đồng' ? 'selected' : '' }}>Lâm Đồng</option>
                                                <option value="Lạng Sơn" {{ old('province', $collectionPoint->province) == 'Lạng Sơn' ? 'selected' : '' }}>Lạng Sơn</option>
                                                <option value="Lào Cai" {{ old('province', $collectionPoint->province) == 'Lào Cai' ? 'selected' : '' }}>Lào Cai</option>
                                                <option value="Long An" {{ old('province', $collectionPoint->province) == 'Long An' ? 'selected' : '' }}>Long An</option>
                                                <option value="Nam Định" {{ old('province', $collectionPoint->province) == 'Nam Định' ? 'selected' : '' }}>Nam Định</option>
                                                <option value="Nghệ An" {{ old('province', $collectionPoint->province) == 'Nghệ An' ? 'selected' : '' }}>Nghệ An</option>
                                                <option value="Ninh Bình" {{ old('province', $collectionPoint->province) == 'Ninh Bình' ? 'selected' : '' }}>Ninh Bình</option>
                                                <option value="Ninh Thuận" {{ old('province', $collectionPoint->province) == 'Ninh Thuận' ? 'selected' : '' }}>Ninh Thuận</option>
                                                <option value="Phú Thọ" {{ old('province', $collectionPoint->province) == 'Phú Thọ' ? 'selected' : '' }}>Phú Thọ</option>
                                                <option value="Phú Yên" {{ old('province', $collectionPoint->province) == 'Phú Yên' ? 'selected' : '' }}>Phú Yên</option>
                                                <option value="Quảng Bình" {{ old('province', $collectionPoint->province) == 'Quảng Bình' ? 'selected' : '' }}>Quảng Bình</option>
                                                <option value="Quảng Nam" {{ old('province', $collectionPoint->province) == 'Quảng Nam' ? 'selected' : '' }}>Quảng Nam</option>
                                                <option value="Quảng Ngãi" {{ old('province', $collectionPoint->province) == 'Quảng Ngãi' ? 'selected' : '' }}>Quảng Ngãi</option>
                                                <option value="Quảng Ninh" {{ old('province', $collectionPoint->province) == 'Quảng Ninh' ? 'selected' : '' }}>Quảng Ninh</option>
                                                <option value="Quảng Trị" {{ old('province', $collectionPoint->province) == 'Quảng Trị' ? 'selected' : '' }}>Quảng Trị</option>
                                                <option value="Sóc Trăng" {{ old('province', $collectionPoint->province) == 'Sóc Trăng' ? 'selected' : '' }}>Sóc Trăng</option>
                                                <option value="Sơn La" {{ old('province', $collectionPoint->province) == 'Sơn La' ? 'selected' : '' }}>Sơn La</option>
                                                <option value="Tây Ninh" {{ old('province', $collectionPoint->province) == 'Tây Ninh' ? 'selected' : '' }}>Tây Ninh</option>
                                                <option value="Thái Bình" {{ old('province', $collectionPoint->province) == 'Thái Bình' ? 'selected' : '' }}>Thái Bình</option>
                                                <option value="Thái Nguyên" {{ old('province', $collectionPoint->province) == 'Thái Nguyên' ? 'selected' : '' }}>Thái Nguyên</option>
                                                <option value="Thanh Hóa" {{ old('province', $collectionPoint->province) == 'Thanh Hóa' ? 'selected' : '' }}>Thanh Hóa</option>
                                                <option value="Thừa Thiên Huế" {{ old('province', $collectionPoint->province) == 'Thừa Thiên Huế' ? 'selected' : '' }}>Thừa Thiên Huế</option>
                                                <option value="Tiền Giang" {{ old('province', $collectionPoint->province) == 'Tiền Giang' ? 'selected' : '' }}>Tiền Giang</option>
                                                <option value="Trà Vinh" {{ old('province', $collectionPoint->province) == 'Trà Vinh' ? 'selected' : '' }}>Trà Vinh</option>
                                                <option value="Tuyên Quang" {{ old('province', $collectionPoint->province) == 'Tuyên Quang' ? 'selected' : '' }}>Tuyên Quang</option>
                                                <option value="Vĩnh Long" {{ old('province', $collectionPoint->province) == 'Vĩnh Long' ? 'selected' : '' }}>Vĩnh Long</option>
                                                <option value="Vĩnh Phúc" {{ old('province', $collectionPoint->province) == 'Vĩnh Phúc' ? 'selected' : '' }}>Vĩnh Phúc</option>
                                                <option value="Yên Bái" {{ old('province', $collectionPoint->province) == 'Yên Bái' ? 'selected' : '' }}>Yên Bái</option>
                                            </select>
                                            @error('province')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                           ...
                                           id="address_note"
                                           name="address_note"
                                           value="{{ old('address_note', $collectionPoint->address_note) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="hidden" id="latitude" name="latitude" value="{{ $collectionPoint->latitude ?? '' }}">
                                    <input type="hidden" id="longitude" name="longitude" value="{{ $collectionPoint->longitude ?? '' }}">
                                </div>
...
// Get existing data
const existingProvince = '{{ old('province', $collectionPoint->province) }}';
const existingDistrict = '{{ old('district', $collectionPoint->district) }}';
const existingLatitude = {{ $collectionPoint->latitude ?? 'null' }};
const existingLongitude = {{ $collectionPoint->longitude ?? 'null' }};

console.log('[EDIT] Existing coordinates:', existingLatitude, existingLongitude);

// District data (same as create page)
const districtData = {
...
function loadExistingData() {
    // Load existing district data
    if (existingProvince) {
        updateDistrictDropdown();
        if (existingDistrict) {
            const districtEl = document.getElementById('district');
            if (districtEl) {
                districtEl.value = existingDistrict;
            }
        }

        // Load existing marker position if coordinates exist
        setTimeout(() => {
            if (existingLatitude && existingLongitude) {
                console.log('[EDIT] Setting marker to saved coordinates:', existingLongitude, existingLatitude);
                marker.setLngLat([existingLongitude, existingLatitude]);
                map.flyTo({
                    center: [existingLongitude, existingLatitude],
                    zoom: 15
                });
            } else if (existingDistrict) {
                console.log('[EDIT] No coordinates, zooming to district:', existingDistrict);
                zoomToDistrict(existingProvince, existingDistrict);
            } else {
                console.log('[EDIT] No coordinates, zooming to province:', existingProvince);
                zoomToProvince(existingProvince);
            }
        }, 500);
    }
}
...
function updateCoordinateInputs(lng, lat) {
    ...
    console.log('[EDIT] Coordinates updated:', lat, lng);
}
...
function geocodeFullAddress() {
    const detailed = $('#detailed_address').val();
    const ward = $('#ward').val();
        ...
        .then(data => {
            if (data.features && data.features.length > 0) {
                ...
                place.context?.forEach(ctx => {
                    if (ctx.id.includes('place')) {
                        ...
                        provinceSelect.find('option').each(function() {
                            if ($(this).text().includes(cityName)) {
                ...
                if (place.properties?.address || place.text) {
                    ...
                    $('#detailed_address').val(streetName);
                }
            }
...
console.log('=== INLINE MAP SCRIPT ENDED (EDIT) ===');
})();
</script>
@endsection
